...
class TestImport(unittest.TestCase):
    ...
    def test_upsample_atteention_is_accessible(self):
            ...
            from utils import UpSampleAttention
    ...
    def test_doubleconv_is_not_accessible(self):
        ...
        try:
            from utils import DoubleConv  # Intentamos importar DoubleConv
    ...
    def test_attentiongate_is_not_accessible(self):
        ...
        try:
            from utils import AttentionGate  # Intentamos importar AttentionGate
